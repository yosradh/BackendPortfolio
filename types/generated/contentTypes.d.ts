...
export interface ApiCategorieCategorie extends Schema.CollectionType {
  ...
  attributes: {
    nomCategorie: Attribute.String & Attribute.Required & Attribute.Unique;
...
export interface ApiToolTool extends Schema.CollectionType {
  ...
  attributes: {
    ...
    imageTool: Attribute.Media & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
